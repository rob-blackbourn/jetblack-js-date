...
describe('dateFormat', () => {
  ...
  it('should pad d when necessary', () => {
    expect(dateFormat(new Date('2001-01-09T00:00:00Z'), 'd', {}, tzUtc)).toBe(
      '9'
    )
    expect(dateFormat(new Date('2001-01-19T00:00:00Z'), 'd', {}, tzUtc)).toBe(
      '19'
    )
  })

  it('should always pad dd when necessary', () => {
    expect(dateFormat(new Date('2001-01-09T00:00:00Z'), 'dd', {}, tzUtc)).toBe(
      '09'
    )
    expect(dateFormat(new Date('2001-01-19T00:00:00Z'), 'dd', {}, tzUtc)).toBe(
      '19'
    )
  })
})
